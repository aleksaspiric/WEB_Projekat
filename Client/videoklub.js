...
export class VideoKlub
{
    ...
    // // let donji = document.createElement("div");
    // // donji.className = "donji";
    // // cont.appendChild(donji);
    // let vk = [];
    // fetch("https://localhost:5001/VideoKlub/vratiSveVideoKlubove", {method:"GET"})
    //     .then(response => response.json())
    //     .then(videoklubovi => {
    ...
    // klik(){
    //     let vk = this.container.querySelector("input[name='radioTip']:checked").value;
    //     console.log(vk);

    //     this.crtajNovi(this.container, vk);
    // }
